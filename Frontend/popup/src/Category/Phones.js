    ...
    return(
        <>
            ...
            <div className='category'>
                ...
                <div className='realme' style={{backgroundImage: `url(https://whatthelogo.com/storage/logos/realme-75525.webp)`, backgroundSize: '250px auto', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', color: 'white'}}>
                   <h1> . </h1>
                </div>
            </div>
            <Footer/>
