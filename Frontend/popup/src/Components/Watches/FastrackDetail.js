    ...
    const fetchDetail = async () => {
        try{
            ...
            if(response.ok){
                ...
                const content = data.watches.fastrack.find(item => item.url_name === url_name)
        ...
        <>
            ...
            <div className="content">
                <div className="left">
                    ...
                    <br/><br/>
                    <img name='image' src={detail.image} width={600} height={600} alt="Image not found"/><br/><br/>
                ...
                <div className="right">
                    ...
                    <h3> Feature: <i style={{fontWeight: 'lighter'}}>{detail.features}</i> </h3>
                    <br/>
                    <br/>
...
export default FastrackWatchDetail